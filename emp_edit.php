...
<body>
    ...
    <div class="container" style="background-color: rgba(255, 255, 255, 0.5); width:500px;">
        ...
        ?>
                ...
                <form id="edit-employee-form" method="post">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            <label for="employee-schedule-days" class="form-label">Schedule Days:</label>
                            <input type="text" id="employee-schedule-days" name="employee-schedule-days" value="<?php echo $row['schedule_days']; ?>" class="form-control">
                        </div>
                    </div>
        ...
        if (isset($_POST['submit'])) {
            ...
            $schedule_days = $_POST['employee-schedule-days'];
